...
const APK_FILENAME = 'VibTribe-v2.1.3.apk';
...
const STEPS: StepDef[] = [
  { id: 1, title: 'Download APK', subtitle: 'Save VibTribe-v2.1.3.apk', icon: Download },
        ...
        <section className="glass rounded-3xl border border-border p-5 sm:p-7">
          {step === 1 && (
            ...
            >
              ...
              >
                <Download size={16} /> Download VibTribe-v2.1.3.apk
              </a>
              {downloadStarted && (
