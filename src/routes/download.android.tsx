...
const APK_HREF = '/VibTribe_v1.1.1.apk';
const APK_FILENAME = 'VibTribe_v1.1.1.apk';
...
const STEPS: StepDef[] = [
  { id: 1, title: 'Download APK', subtitle: 'Save VibTribe_v1.1.1.apk', icon: Download },
        ...
        <section className="glass rounded-3xl border border-border p-5 sm:p-7">
          {step === 1 && (
            <StepCard
              eyebrow="Step 1 of 5"
              icon={Download}
              title="Download the VibTribe APK (v1.1.1)"
              body="Tap the button below. The file will save to your phone as VibTribe_v1.1.1.apk (about 38 MB). Use Wi-Fi for the fastest download. This is the latest official Android release — version 1.1.1."
            >
              <a
                href={APK_HREF}
              ...
              >
                <Download size={16} /> Download VibTribe_v1.1.1.apk
              </a>
              {downloadStarted && (
