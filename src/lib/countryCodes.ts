// Comprehensive list of countries with ISO alpha-2 code and international
// dialing code. The flag is rendered from the alpha-2 code using the regional
// indicator unicode trick so we don't need to ship emoji assets.
...
// Source: ITU-T E.164 dial codes. Sorted alphabetically by country name below.
const RAW: Country[] = [
...
export function findCountryByIso2(iso2?: string | null): Country | undefined {
  if (!iso2) return undefined;
  const up = iso2.toUpperCase();
  return COUNTRIES.find(c => c.iso2 === up);
}

export function findCountryByDial(dial?: string | null): Country | undefined {
...
export const DEFAULT_COUNTRY: Country =
  findCountryByIso2('IN') ?? COUNTRIES[0];